// CHATFLOW Penpot Plugin v4.3 - DETAILED PAGE DRAWING
...
console.log('=== CHATFLOW Plugin v4.3 START ===');
...
for (var i = 0; i < DETAILED_PAGES.length; i++) {
  ...
  try {
    ...
    // Draw page content in board-local coordinates to ensure visibility
    pg.draw(board, 0, 0);
