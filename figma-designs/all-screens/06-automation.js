...
screen.name="01-working-hours - Working Hours";
screen.resize(1440,900);
screen.fills=[{type:'SOLID',color:BG}];
screen.x=0;screen.y=6000;
  ...
  // Nav: Automation
  var nav4=frame(sidebar,"Nav Automation",240,36,{x:10,y:240,color:PRIMARY ,radius:8});
  
  txt(nav4,"Automation",{style:"Medium",size:13,color:WHITE,x:36,y:9});
  // Nav: Team
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  txt(headerLeft,"Working Hours",{style:"Semi Bold",size:20,color:G900});
  txt(headerLeft,"Ish vaqti jadvali",{size:13,color:G500});
  ...
  var sTab0=frame(subnav,"Tab Working Hours",128,36,{color:PRIMARY_LIGHT,radius:6,layout:"HORIZONTAL",alignY:"CENTER",alignX:"CENTER"});
  
  txt(sTab0,"Working Hours",{style:"Medium",size:13,color:PRIMARY});
  var sTab1=frame(subnav,"Tab Auto Reply",104,36,{color:{r:0,g:0,b:0},radius:6,layout:"HORIZONTAL",alignY:"CENTER",alignX:"CENTER"});
  sTab1.fills=[];
  txt(sTab1,"Auto Reply",{style:"Medium",size:13,color:G600});
  var sTab2=frame(subnav,"Tab Triggers",88,36,{color:{r:0,g:0,b:0},radius:6,layout:"HORIZONTAL",alignY:"CENTER",alignX:"CENTER"});
  sTab2.fills=[];
  txt(sTab2,"Triggers",{style:"Medium",size:13,color:G600});
  var sTab3=frame(subnav,"Tab Greetings",96,36,{color:{r:0,g:0,b:0},radius:6,layout:"HORIZONTAL",alignY:"CENTER",alignX:"CENTER"});
  sTab3.fills=[];
  txt(sTab3,"Greetings",{style:"Medium",size:13,color:G600});
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  // Card: Working Hours ma'lumotlari
  var card0=frame(content,"Card Working Hours ma'lumotlari",1132,200,{x:24,color:WHITE,radius:12,layout:"VERTICAL",stroke:G200,shadow:true});
  ...
  txt(cardH0,"Working Hours ma'lumotlari",{style:"Semi Bold",size:15,color:G900});
  ...
  txt(cardB0,"Bu sahifada Working Hours bo'limining asosiy kontenti joylashadi.",{size:14,color:G600,w:600,wrap:true});
  txt(cardB0,"HTML sahifa: html/automation/01-working-hours.html",{size:12,color:G400,w:600});
...
var screen=figma.createFrame();
screen.name="02-auto-reply - Auto Reply";
screen.resize(1440,900);
screen.fills=[{type:'SOLID',color:BG}];
screen.x=1560;screen.y=6000;
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  var headerLeft=frame(header,"Header Left",400,40,{layout:"VERTICAL",spacing:2});
  headerLeft.primaryAxisSizingMode="AUTO";headerLeft.counterAxisSizingMode="AUTO";
  txt(headerLeft,"Auto Reply",{style:"Semi Bold",size:20,color:G900});
  txt(headerLeft,"Avtomatik javoblar",{size:13,color:G500});
  var headerActions=frame(header,"Actions",300,36,{layout:"HORIZONTAL",spacing:8});
  headerActions.primaryAxisSizingMode="AUTO";headerActions.counterAxisSizingMode="AUTO";
  headerActions.primaryAxisAlignItems="MAX";
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  // Card: Auto Reply ma'lumotlari
  var card0=frame(content,"Card Auto Reply ma'lumotlari",1132,200,{x:24,color:WHITE,radius:12,layout:"VERTICAL",stroke:G200,shadow:true});
  card0.primaryAxisSizingMode="AUTO";
  var cardH0=frame(card0,"Card Header",1132,48,{color:WHITE,layout:"HORIZONTAL",padX:20,padY:14,alignX:"CENTER"});
  cardH0.primaryAxisAlignItems="SPACE_BETWEEN";cardH0.layoutSizingHorizontal="FILL";
  txt(cardH0,"Auto Reply ma'lumotlari",{style:"Semi Bold",size:15,color:G900});
  var cardB0=frame(card0,"Card Body",1132,150,{padX:20,padY:16});
  cardB0.layoutSizingHorizontal="FILL";cardB0.primaryAxisSizingMode="AUTO";cardB0.layoutMode="VERTICAL";cardB0.itemSpacing=8;
  
  txt(cardB0,"Bu sahifada Auto Reply bo'limining asosiy kontenti joylashadi.",{size:14,color:G600,w:600,wrap:true});
  txt(cardB0,"HTML sahifa: html/automation/02-auto-reply.html",{size:12,color:G400,w:600});
...
// AUTOMATION / Triggers
var screen=figma.createFrame();
screen.name="03-triggers - Triggers";
screen.resize(1440,900);
screen.fills=[{type:'SOLID',color:BG}];
screen.x=3120;screen.y=6000;
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  var headerLeft=frame(header,"Header Left",400,40,{layout:"VERTICAL",spacing:2});
  headerLeft.primaryAxisSizingMode="AUTO";headerLeft.counterAxisSizingMode="AUTO";
  txt(headerLeft,"Triggers",{style:"Semi Bold",size:20,color:G900});
  txt(headerLeft,"Trigger qoidalar ro'yxati",{size:13,color:G500});
  var headerActions=frame(header,"Actions",300,36,{layout:"HORIZONTAL",spacing:8});
  headerActions.primaryAxisSizingMode="AUTO";headerActions.counterAxisSizingMode="AUTO";
  headerActions.primaryAxisAlignItems="MAX";
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  // Card: Triggers ma'lumotlari
  var card0=frame(content,"Card Triggers ma'lumotlari",1132,200,{x:24,color:WHITE,radius:12,layout:"VERTICAL",stroke:G200,shadow:true});
  card0.primaryAxisSizingMode="AUTO";
  var cardH0=frame(card0,"Card Header",1132,48,{color:WHITE,layout:"HORIZONTAL",padX:20,padY:14,alignX:"CENTER"});
  cardH0.primaryAxisAlignItems="SPACE_BETWEEN";cardH0.layoutSizingHorizontal="FILL";
  txt(cardH0,"Triggers ma'lumotlari",{style:"Semi Bold",size:15,color:G900});
  var cardB0=frame(card0,"Card Body",1132,150,{padX:20,padY:16});
  cardB0.layoutSizingHorizontal="FILL";cardB0.primaryAxisSizingMode="AUTO";cardB0.layoutMode="VERTICAL";cardB0.itemSpacing=8;
  
  txt(cardB0,"Bu sahifada Triggers bo'limining asosiy kontenti joylashadi.",{size:14,color:G600,w:600,wrap:true});
  txt(cardB0,"HTML sahifa: html/automation/03-triggers.html",{size:12,color:G400,w:600});
...
var screen=figma.createFrame();
screen.name="04-greetings - Greetings";
screen.resize(1440,900);
screen.fills=[{type:'SOLID',color:BG}];
screen.x=4680;screen.y=6000;
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  var headerLeft=frame(header,"Header Left",400,40,{layout:"VERTICAL",spacing:2});
  headerLeft.primaryAxisSizingMode="AUTO";headerLeft.counterAxisSizingMode="AUTO";
  txt(headerLeft,"Greetings",{style:"Semi Bold",size:20,color:G900});
  txt(headerLeft,"Salomlashuv xabarlari",{size:13,color:G500});
  var headerActions=frame(header,"Actions",300,36,{layout:"HORIZONTAL",spacing:8});
  headerActions.primaryAxisSizingMode="AUTO";headerActions.counterAxisSizingMode="AUTO";
  headerActions.primaryAxisAlignItems="MAX";
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  // Card: Greetings ma'lumotlari
  var card0=frame(content,"Card Greetings ma'lumotlari",1132,200,{x:24,color:WHITE,radius:12,layout:"VERTICAL",stroke:G200,shadow:true});
  card0.primaryAxisSizingMode="AUTO";
  var cardH0=frame(card0,"Card Header",1132,48,{color:WHITE,layout:"HORIZONTAL",padX:20,padY:14,alignX:"CENTER"});
  cardH0.primaryAxisAlignItems="SPACE_BETWEEN";cardH0.layoutSizingHorizontal="FILL";
  txt(cardH0,"Greetings ma'lumotlari",{style:"Semi Bold",size:15,color:G900});
  var cardB0=frame(card0,"Card Body",1132,150,{padX:20,padY:16});
  cardB0.layoutSizingHorizontal="FILL";cardB0.primaryAxisSizingMode="AUTO";cardB0.layoutMode="VERTICAL";cardB0.itemSpacing=8;
  
  txt(cardB0,"Bu sahifada Greetings bo'limining asosiy kontenti joylashadi.",{size:14,color:G600,w:600,wrap:true});
  txt(cardB0,"HTML sahifa: html/automation/04-greetings.html",{size:12,color:G400,w:600});
...
return {success:true, section:"AUTOMATION", screens:4};
