...
screen.name="01-addons-catalog - Addons Catalog";
screen.resize(1440,900);
screen.fills=[{type:'SOLID',color:BG}];
screen.x=0;screen.y=19800;
  ...
  // Nav: Addons
  var nav9=frame(sidebar,"Nav Addons",240,36,{x:10,y:440,color:PRIMARY ,radius:8});
  
  txt(nav9,"Addons",{style:"Medium",size:13,color:WHITE,x:36,y:9});
  // Nav: Developer
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  txt(headerLeft,"Addons Catalog",{style:"Semi Bold",size:20,color:G900});
  txt(headerLeft,"Marketplace katalogi",{size:13,color:G500});
  ...
  var sTab0=frame(subnav,"Tab Catalog",80,36,{color:PRIMARY_LIGHT,radius:6,layout:"HORIZONTAL",alignY:"CENTER",alignX:"CENTER"});
  
  txt(sTab0,"Catalog",{style:"Medium",size:13,color:PRIMARY});
  var sTab1=frame(subnav,"Tab Active Addons",128,36,{color:{r:0,g:0,b:0},radius:6,layout:"HORIZONTAL",alignY:"CENTER",alignX:"CENTER"});
  sTab1.fills=[];
  txt(sTab1,"Active Addons",{style:"Medium",size:13,color:G600});
  var sTab2=frame(subnav,"Tab Addon Detail",120,36,{color:{r:0,g:0,b:0},radius:6,layout:"HORIZONTAL",alignY:"CENTER",alignX:"CENTER"});
  sTab2.fills=[];
  txt(sTab2,"Addon Detail",{style:"Medium",size:13,color:G600});
  var sTab3=frame(subnav,"Tab Addon Settings",136,36,{color:{r:0,g:0,b:0},radius:6,layout:"HORIZONTAL",alignY:"CENTER",alignX:"CENTER"});
  sTab3.fills=[];
  txt(sTab3,"Addon Settings",{style:"Medium",size:13,color:G600});
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  // Card: Addons Catalog ma'lumotlari
  var card0=frame(content,"Card Addons Catalog ma'lumotlari",1132,200,{x:24,color:WHITE,radius:12,layout:"VERTICAL",stroke:G200,shadow:true});
  ...
  txt(cardH0,"Addons Catalog ma'lumotlari",{style:"Semi Bold",size:15,color:G900});
  ...
  txt(cardB0,"Bu sahifada Addons Catalog bo'limining asosiy kontenti joylashadi.",{size:14,color:G600,w:600,wrap:true});
  txt(cardB0,"HTML sahifa: html/addons/01-addons-catalog.html",{size:12,color:G400,w:600});
...
// ADDONS / Active Addons
var screen=figma.createFrame();
screen.name="02-active-addons - Active Addons";
screen.resize(1440,900);
screen.fills=[{type:'SOLID',color:BG}];
screen.x=1560;screen.y=19800;
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  var headerLeft=frame(header,"Header Left",400,40,{layout:"VERTICAL",spacing:2});
  headerLeft.primaryAxisSizingMode="AUTO";headerLeft.counterAxisSizingMode="AUTO";
  txt(headerLeft,"Active Addons",{style:"Semi Bold",size:20,color:G900});
  txt(headerLeft,"Faol qo'shimchalar",{size:13,color:G500});
  var headerActions=frame(header,"Actions",300,36,{layout:"HORIZONTAL",spacing:8});
  headerActions.primaryAxisSizingMode="AUTO";headerActions.counterAxisSizingMode="AUTO";
  headerActions.primaryAxisAlignItems="MAX";
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  // Card: Active Addons ma'lumotlari
  var card0=frame(content,"Card Active Addons ma'lumotlari",1132,200,{x:24,color:WHITE,radius:12,layout:"VERTICAL",stroke:G200,shadow:true});
  card0.primaryAxisSizingMode="AUTO";
  var cardH0=frame(card0,"Card Header",1132,48,{color:WHITE,layout:"HORIZONTAL",padX:20,padY:14,alignX:"CENTER"});
  cardH0.primaryAxisAlignItems="SPACE_BETWEEN";cardH0.layoutSizingHorizontal="FILL";
  txt(cardH0,"Active Addons ma'lumotlari",{style:"Semi Bold",size:15,color:G900});
  var cardB0=frame(card0,"Card Body",1132,150,{padX:20,padY:16});
  cardB0.layoutSizingHorizontal="FILL";cardB0.primaryAxisSizingMode="AUTO";cardB0.layoutMode="VERTICAL";cardB0.itemSpacing=8;
  
  txt(cardB0,"Bu sahifada Active Addons bo'limining asosiy kontenti joylashadi.",{size:14,color:G600,w:600,wrap:true});
  txt(cardB0,"HTML sahifa: html/addons/02-active-addons.html",{size:12,color:G400,w:600});
...
// ADDONS / Addon Detail
var screen=figma.createFrame();
screen.name="03-addon-detail - Addon Detail";
screen.resize(1440,900);
screen.fills=[{type:'SOLID',color:BG}];
screen.x=3120;screen.y=19800;
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  var headerLeft=frame(header,"Header Left",400,40,{layout:"VERTICAL",spacing:2});
  headerLeft.primaryAxisSizingMode="AUTO";headerLeft.counterAxisSizingMode="AUTO";
  txt(headerLeft,"Addon Detail",{style:"Semi Bold",size:20,color:G900});
  txt(headerLeft,"Qo'shimcha batafsil",{size:13,color:G500});
  var headerActions=frame(header,"Actions",300,36,{layout:"HORIZONTAL",spacing:8});
  headerActions.primaryAxisSizingMode="AUTO";headerActions.counterAxisSizingMode="AUTO";
  headerActions.primaryAxisAlignItems="MAX";
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  // Card: Addon Detail ma'lumotlari
  var card0=frame(content,"Card Addon Detail ma'lumotlari",1132,200,{x:24,color:WHITE,radius:12,layout:"VERTICAL",stroke:G200,shadow:true});
  card0.primaryAxisSizingMode="AUTO";
  var cardH0=frame(card0,"Card Header",1132,48,{color:WHITE,layout:"HORIZONTAL",padX:20,padY:14,alignX:"CENTER"});
  cardH0.primaryAxisAlignItems="SPACE_BETWEEN";cardH0.layoutSizingHorizontal="FILL";
  txt(cardH0,"Addon Detail ma'lumotlari",{style:"Semi Bold",size:15,color:G900});
  var cardB0=frame(card0,"Card Body",1132,150,{padX:20,padY:16});
  cardB0.layoutSizingHorizontal="FILL";cardB0.primaryAxisSizingMode="AUTO";cardB0.layoutMode="VERTICAL";cardB0.itemSpacing=8;
  
  txt(cardB0,"Bu sahifada Addon Detail bo'limining asosiy kontenti joylashadi.",{size:14,color:G600,w:600,wrap:true});
  txt(cardB0,"HTML sahifa: html/addons/03-addon-detail.html",{size:12,color:G400,w:600});
...
var screen=figma.createFrame();
screen.name="04-addon-settings - Addon Settings";
screen.resize(1440,900);
screen.fills=[{type:'SOLID',color:BG}];
screen.x=4680;screen.y=19800;
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  var headerLeft=frame(header,"Header Left",400,40,{layout:"VERTICAL",spacing:2});
  headerLeft.primaryAxisSizingMode="AUTO";headerLeft.counterAxisSizingMode="AUTO";
  txt(headerLeft,"Addon Settings",{style:"Semi Bold",size:20,color:G900});
  txt(headerLeft,"Qo'shimcha sozlamalari",{size:13,color:G500});
  var headerActions=frame(header,"Actions",300,36,{layout:"HORIZONTAL",spacing:8});
  headerActions.primaryAxisSizingMode="AUTO";headerActions.counterAxisSizingMode="AUTO";
  headerActions.primaryAxisAlignItems="MAX";
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  // Card: Addon Settings ma'lumotlari
  var card0=frame(content,"Card Addon Settings ma'lumotlari",1132,200,{x:24,color:WHITE,radius:12,layout:"VERTICAL",stroke:G200,shadow:true});
  card0.primaryAxisSizingMode="AUTO";
  var cardH0=frame(card0,"Card Header",1132,48,{color:WHITE,layout:"HORIZONTAL",padX:20,padY:14,alignX:"CENTER"});
  cardH0.primaryAxisAlignItems="SPACE_BETWEEN";cardH0.layoutSizingHorizontal="FILL";
  txt(cardH0,"Addon Settings ma'lumotlari",{style:"Semi Bold",size:15,color:G900});
  var cardB0=frame(card0,"Card Body",1132,150,{padX:20,padY:16});
  cardB0.layoutSizingHorizontal="FILL";cardB0.primaryAxisSizingMode="AUTO";cardB0.layoutMode="VERTICAL";cardB0.itemSpacing=8;
  
  txt(cardB0,"Bu sahifada Addon Settings bo'limining asosiy kontenti joylashadi.",{size:14,color:G600,w:600,wrap:true});
  txt(cardB0,"HTML sahifa: html/addons/04-addon-settings.html",{size:12,color:G400,w:600});
...
return {success:true, section:"ADDONS", screens:4};
