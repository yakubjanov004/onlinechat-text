...
screen.x=0;screen.y=3600;
  ...
  // Nav: Dashboard
  var nav0=frame(sidebar,"Nav Dashboard",240,36,{x:10,y:80,color:PRIMARY ,radius:8});
  
  txt(nav0,"Dashboard",{style:"Medium",size:13,color:WHITE,x:36,y:9});
  // Nav: Inbox
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  txt(headerLeft,"Dashboard tanlash",{style:"Semi Bold",size:20,color:G900});
  txt(headerLeft,"Rolga mos dashboard",{size:13,color:G500});
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  // Card: Dashboard tanlash ma'lumotlari
  var card0=frame(content,"Card Dashboard tanlash ma'lumotlari",1132,200,{x:24,color:WHITE,radius:12,layout:"VERTICAL",stroke:G200,shadow:true});
  ...
  txt(cardH0,"Dashboard tanlash ma'lumotlari",{style:"Semi Bold",size:15,color:G900});
  ...
  txt(cardB0,"Bu sahifada Dashboard tanlash bo'limining asosiy kontenti joylashadi.",{size:14,color:G600,w:600,wrap:true});
  txt(cardB0,"HTML sahifa: html/dashboard/01-dashboard.html",{size:12,color:G400,w:600});
...
var screen=figma.createFrame();
screen.name="01-dashboard-admin - Admin Dashboard";
screen.resize(1440,900);
screen.fills=[{type:'SOLID',color:BG}];
screen.x=1560;screen.y=3600;
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  var headerLeft=frame(header,"Header Left",400,40,{layout:"VERTICAL",spacing:2});
  headerLeft.primaryAxisSizingMode="AUTO";headerLeft.counterAxisSizingMode="AUTO";
  txt(headerLeft,"Admin Dashboard",{style:"Semi Bold",size:20,color:G900});
  txt(headerLeft,"KPI, SLA nazorati",{size:13,color:G500});
  var headerActions=frame(header,"Actions",300,36,{layout:"HORIZONTAL",spacing:8});
  headerActions.primaryAxisSizingMode="AUTO";headerActions.counterAxisSizingMode="AUTO";
  headerActions.primaryAxisAlignItems="MAX";
  ...
  var mc0=frame(metricsRow,"Metric Faol chatlar",270,100,{color:WHITE,radius:12,layout:"VERTICAL",spacing:6,pad:20,stroke:G200,shadow:true});
  txt(mc0,"Faol chatlar",{size:13,color:G500});
  txt(mc0,"47",{style:"Bold",size:28,color:G900});
  txt(mc0,"+12%",{size:12,color:SUCCESS});
  
  var mc1=frame(metricsRow,"Metric Javob vaqti",270,100,{color:WHITE,radius:12,layout:"VERTICAL",spacing:6,pad:20,stroke:G200,shadow:true});
  txt(mc1,"Javob vaqti",{size:13,color:G500});
  txt(mc1,"1.2m",{style:"Bold",size:28,color:G900});
  txt(mc1,"-8%",{size:12,color:DANGER});
  
  var mc2=frame(metricsRow,"Metric CSAT bali",270,100,{color:WHITE,radius:12,layout:"VERTICAL",spacing:6,pad:20,stroke:G200,shadow:true});
  txt(mc2,"CSAT bali",{size:13,color:G500});
  txt(mc2,"4.6",{style:"Bold",size:28,color:G900});
  txt(mc2,"+3%",{size:12,color:SUCCESS});
  
  var mc3=frame(metricsRow,"Metric SLA rioya",270,100,{color:WHITE,radius:12,layout:"VERTICAL",spacing:6,pad:20,stroke:G200,shadow:true});
  txt(mc3,"SLA rioya",{size:13,color:G500});
  txt(mc3,"94%",{style:"Bold",size:28,color:G900});
  txt(mc3,"+2%",{size:12,color:SUCCESS});
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  // Card: Admin Dashboard ma'lumotlari
  var card0=frame(content,"Card Admin Dashboard ma'lumotlari",1132,200,{x:24,color:WHITE,radius:12,layout:"VERTICAL",stroke:G200,shadow:true});
  card0.primaryAxisSizingMode="AUTO";
  var cardH0=frame(card0,"Card Header",1132,48,{color:WHITE,layout:"HORIZONTAL",padX:20,padY:14,alignX:"CENTER"});
  cardH0.primaryAxisAlignItems="SPACE_BETWEEN";cardH0.layoutSizingHorizontal="FILL";
  txt(cardH0,"Admin Dashboard ma'lumotlari",{style:"Semi Bold",size:15,color:G900});
  var cardB0=frame(card0,"Card Body",1132,150,{padX:20,padY:16});
  cardB0.layoutSizingHorizontal="FILL";cardB0.primaryAxisSizingMode="AUTO";cardB0.layoutMode="VERTICAL";cardB0.itemSpacing=8;
  
  txt(cardB0,"Bu sahifada Admin Dashboard bo'limining asosiy kontenti joylashadi.",{size:14,color:G600,w:600,wrap:true});
  txt(cardB0,"HTML sahifa: html/dashboard/01-dashboard-admin.html",{size:12,color:G400,w:600});
...
var screen=figma.createFrame();
screen.name="02-dashboard-agent - Agent Dashboard";
screen.resize(1440,900);
screen.fills=[{type:'SOLID',color:BG}];
screen.x=3120;screen.y=3600;
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  var headerLeft=frame(header,"Header Left",400,40,{layout:"VERTICAL",spacing:2});
  headerLeft.primaryAxisSizingMode="AUTO";headerLeft.counterAxisSizingMode="AUTO";
  txt(headerLeft,"Agent Dashboard",{style:"Semi Bold",size:20,color:G900});
  txt(headerLeft,"Mening navbatim",{size:13,color:G500});
  var headerActions=frame(header,"Actions",300,36,{layout:"HORIZONTAL",spacing:8});
  headerActions.primaryAxisSizingMode="AUTO";headerActions.counterAxisSizingMode="AUTO";
  headerActions.primaryAxisAlignItems="MAX";
  ...
  var mc0=frame(metricsRow,"Metric Mening chatlarim",270,100,{color:WHITE,radius:12,layout:"VERTICAL",spacing:6,pad:20,stroke:G200,shadow:true});
  txt(mc0,"Mening chatlarim",{size:13,color:G500});
  txt(mc0,"8",{style:"Bold",size:28,color:G900});
  txt(mc0,"3 yangi",{size:12,color:G500});
  ...
  txt(mc1,"45s",{style:"Bold",size:28,color:G900});
  txt(mc1,"-12%",{size:12,color:DANGER});
  
  var mc2=frame(metricsRow,"Metric Bugun yopilgan",270,100,{color:WHITE,radius:12,layout:"VERTICAL",spacing:6,pad:20,stroke:G200,shadow:true});
  txt(mc2,"Bugun yopilgan",{size:13,color:G500});
  txt(mc2,"23",{style:"Bold",size:28,color:G900});
  txt(mc2,"+5",{size:12,color:SUCCESS});
  
  var mc3=frame(metricsRow,"Metric Reyting",270,100,{color:WHITE,radius:12,layout:"VERTICAL",spacing:6,pad:20,stroke:G200,shadow:true});
  txt(mc3,"Reyting",{size:13,color:G500});
  txt(mc3,"4.8",{style:"Bold",size:28,color:G900});
  txt(mc3,"⭐",{size:12,color:G500});
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  // Card: Agent Dashboard ma'lumotlari
  var card0=frame(content,"Card Agent Dashboard ma'lumotlari",1132,200,{x:24,color:WHITE,radius:12,layout:"VERTICAL",stroke:G200,shadow:true});
  card0.primaryAxisSizingMode="AUTO";
  var cardH0=frame(card0,"Card Header",1132,48,{color:WHITE,layout:"HORIZONTAL",padX:20,padY:14,alignX:"CENTER"});
  cardH0.primaryAxisAlignItems="SPACE_BETWEEN";cardH0.layoutSizingHorizontal="FILL";
  txt(cardH0,"Agent Dashboard ma'lumotlari",{style:"Semi Bold",size:15,color:G900});
  var cardB0=frame(card0,"Card Body",1132,150,{padX:20,padY:16});
  cardB0.layoutSizingHorizontal="FILL";cardB0.primaryAxisSizingMode="AUTO";cardB0.layoutMode="VERTICAL";cardB0.itemSpacing=8;
  
  txt(cardB0,"Bu sahifada Agent Dashboard bo'limining asosiy kontenti joylashadi.",{size:14,color:G600,w:600,wrap:true});
  txt(cardB0,"HTML sahifa: html/dashboard/02-dashboard-agent.html",{size:12,color:G400,w:600});
...
return {success:true, section:"DASHBOARD", screens:3};
