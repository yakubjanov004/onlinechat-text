...
screen.name="01-contacts-list - Contacts";
screen.resize(1440,900);
screen.fills=[{type:'SOLID',color:BG}];
screen.x=0;screen.y=14400;
  ...
  // Nav: Contacts
  var nav2=frame(sidebar,"Nav Contacts",240,36,{x:10,y:160,color:PRIMARY ,radius:8});
  
  txt(nav2,"Contacts",{style:"Medium",size:13,color:WHITE,x:36,y:9});
  // Nav: Visitors
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  txt(headerLeft,"Contacts",{style:"Semi Bold",size:20,color:G900});
  txt(headerLeft,"Kontaktlar ro'yxati",{size:13,color:G500});
  ...
  var sTab0=frame(subnav,"Tab Contacts",88,36,{color:PRIMARY_LIGHT,radius:6,layout:"HORIZONTAL",alignY:"CENTER",alignX:"CENTER"});
  
  txt(sTab0,"Contacts",{style:"Medium",size:13,color:PRIMARY});
  var sTab1=frame(subnav,"Tab Contact Profile",144,36,{color:{r:0,g:0,b:0},radius:6,layout:"HORIZONTAL",alignY:"CENTER",alignX:"CENTER"});
  sTab1.fills=[];
  txt(sTab1,"Contact Profile",{style:"Medium",size:13,color:G600});
  var sTab2=frame(subnav,"Tab Organizations",128,36,{color:{r:0,g:0,b:0},radius:6,layout:"HORIZONTAL",alignY:"CENTER",alignX:"CENTER"});
  sTab2.fills=[];
  txt(sTab2,"Organizations",{style:"Medium",size:13,color:G600});
  var sTab3=frame(subnav,"Tab Org Detail",104,36,{color:{r:0,g:0,b:0},radius:6,layout:"HORIZONTAL",alignY:"CENTER",alignX:"CENTER"});
  sTab3.fills=[];
  txt(sTab3,"Org Detail",{style:"Medium",size:13,color:G600});
  var sTab4=frame(subnav,"Tab Segments",88,36,{color:{r:0,g:0,b:0},radius:6,layout:"HORIZONTAL",alignY:"CENTER",alignX:"CENTER"});
  sTab4.fills=[];
  txt(sTab4,"Segments",{style:"Medium",size:13,color:G600});
  var sTab5=frame(subnav,"Tab Import/Export",128,36,{color:{r:0,g:0,b:0},radius:6,layout:"HORIZONTAL",alignY:"CENTER",alignX:"CENTER"});
  sTab5.fills=[];
  txt(sTab5,"Import/Export",{style:"Medium",size:13,color:G600});
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  // Card: Contacts ma'lumotlari
  var card0=frame(content,"Card Contacts ma'lumotlari",1132,200,{x:24,color:WHITE,radius:12,layout:"VERTICAL",stroke:G200,shadow:true});
  ...
  txt(cardH0,"Contacts ma'lumotlari",{style:"Semi Bold",size:15,color:G900});
  ...
  txt(cardB0,"Bu sahifada Contacts bo'limining asosiy kontenti joylashadi.",{size:14,color:G600,w:600,wrap:true});
  txt(cardB0,"HTML sahifa: html/contacts/01-contacts-list.html",{size:12,color:G400,w:600});
...
var screen=figma.createFrame();
screen.name="02-contact-profile - Contact Profile";
screen.resize(1440,900);
screen.fills=[{type:'SOLID',color:BG}];
screen.x=1560;screen.y=14400;
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  var headerLeft=frame(header,"Header Left",400,40,{layout:"VERTICAL",spacing:2});
  headerLeft.primaryAxisSizingMode="AUTO";headerLeft.counterAxisSizingMode="AUTO";
  txt(headerLeft,"Contact Profile",{style:"Semi Bold",size:20,color:G900});
  txt(headerLeft,"Kontakt profili",{size:13,color:G500});
  var headerActions=frame(header,"Actions",300,36,{layout:"HORIZONTAL",spacing:8});
  headerActions.primaryAxisSizingMode="AUTO";headerActions.counterAxisSizingMode="AUTO";
  headerActions.primaryAxisAlignItems="MAX";
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  // Card: Contact Profile ma'lumotlari
  var card0=frame(content,"Card Contact Profile ma'lumotlari",1132,200,{x:24,color:WHITE,radius:12,layout:"VERTICAL",stroke:G200,shadow:true});
  card0.primaryAxisSizingMode="AUTO";
  var cardH0=frame(card0,"Card Header",1132,48,{color:WHITE,layout:"HORIZONTAL",padX:20,padY:14,alignX:"CENTER"});
  cardH0.primaryAxisAlignItems="SPACE_BETWEEN";cardH0.layoutSizingHorizontal="FILL";
  txt(cardH0,"Contact Profile ma'lumotlari",{style:"Semi Bold",size:15,color:G900});
  var cardB0=frame(card0,"Card Body",1132,150,{padX:20,padY:16});
  cardB0.layoutSizingHorizontal="FILL";cardB0.primaryAxisSizingMode="AUTO";cardB0.layoutMode="VERTICAL";cardB0.itemSpacing=8;
  
  txt(cardB0,"Bu sahifada Contact Profile bo'limining asosiy kontenti joylashadi.",{size:14,color:G600,w:600,wrap:true});
  txt(cardB0,"HTML sahifa: html/contacts/02-contact-profile.html",{size:12,color:G400,w:600});
...
var screen=figma.createFrame();
screen.name="03-organizations - Organizations";
screen.resize(1440,900);
screen.fills=[{type:'SOLID',color:BG}];
screen.x=3120;screen.y=14400;
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  var headerLeft=frame(header,"Header Left",400,40,{layout:"VERTICAL",spacing:2});
  headerLeft.primaryAxisSizingMode="AUTO";headerLeft.counterAxisSizingMode="AUTO";
  txt(headerLeft,"Organizations",{style:"Semi Bold",size:20,color:G900});
  txt(headerLeft,"Tashkilotlar",{size:13,color:G500});
  var headerActions=frame(header,"Actions",300,36,{layout:"HORIZONTAL",spacing:8});
  headerActions.primaryAxisSizingMode="AUTO";headerActions.counterAxisSizingMode="AUTO";
  headerActions.primaryAxisAlignItems="MAX";
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  // Card: Organizations ma'lumotlari
  var card0=frame(content,"Card Organizations ma'lumotlari",1132,200,{x:24,color:WHITE,radius:12,layout:"VERTICAL",stroke:G200,shadow:true});
  card0.primaryAxisSizingMode="AUTO";
  var cardH0=frame(card0,"Card Header",1132,48,{color:WHITE,layout:"HORIZONTAL",padX:20,padY:14,alignX:"CENTER"});
  cardH0.primaryAxisAlignItems="SPACE_BETWEEN";cardH0.layoutSizingHorizontal="FILL";
  txt(cardH0,"Organizations ma'lumotlari",{style:"Semi Bold",size:15,color:G900});
  var cardB0=frame(card0,"Card Body",1132,150,{padX:20,padY:16});
  cardB0.layoutSizingHorizontal="FILL";cardB0.primaryAxisSizingMode="AUTO";cardB0.layoutMode="VERTICAL";cardB0.itemSpacing=8;
  
  txt(cardB0,"Bu sahifada Organizations bo'limining asosiy kontenti joylashadi.",{size:14,color:G600,w:600,wrap:true});
  txt(cardB0,"HTML sahifa: html/contacts/03-organizations.html",{size:12,color:G400,w:600});
...
// CONTACTS / Org Detail
var screen=figma.createFrame();
screen.name="04-org-detail - Org Detail";
screen.resize(1440,900);
screen.fills=[{type:'SOLID',color:BG}];
screen.x=4680;screen.y=14400;
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  var headerLeft=frame(header,"Header Left",400,40,{layout:"VERTICAL",spacing:2});
  headerLeft.primaryAxisSizingMode="AUTO";headerLeft.counterAxisSizingMode="AUTO";
  txt(headerLeft,"Org Detail",{style:"Semi Bold",size:20,color:G900});
  txt(headerLeft,"Tashkilot batafsil",{size:13,color:G500});
  var headerActions=frame(header,"Actions",300,36,{layout:"HORIZONTAL",spacing:8});
  headerActions.primaryAxisSizingMode="AUTO";headerActions.counterAxisSizingMode="AUTO";
  headerActions.primaryAxisAlignItems="MAX";
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  // Card: Org Detail ma'lumotlari
  var card0=frame(content,"Card Org Detail ma'lumotlari",1132,200,{x:24,color:WHITE,radius:12,layout:"VERTICAL",stroke:G200,shadow:true});
  card0.primaryAxisSizingMode="AUTO";
  var cardH0=frame(card0,"Card Header",1132,48,{color:WHITE,layout:"HORIZONTAL",padX:20,padY:14,alignX:"CENTER"});
  cardH0.primaryAxisAlignItems="SPACE_BETWEEN";cardH0.layoutSizingHorizontal="FILL";
  txt(cardH0,"Org Detail ma'lumotlari",{style:"Semi Bold",size:15,color:G900});
  var cardB0=frame(card0,"Card Body",1132,150,{padX:20,padY:16});
  cardB0.layoutSizingHorizontal="FILL";cardB0.primaryAxisSizingMode="AUTO";cardB0.layoutMode="VERTICAL";cardB0.itemSpacing=8;
  
  txt(cardB0,"Bu sahifada Org Detail bo'limining asosiy kontenti joylashadi.",{size:14,color:G600,w:600,wrap:true});
  txt(cardB0,"HTML sahifa: html/contacts/04-org-detail.html",{size:12,color:G400,w:600});
...
// CONTACTS / Segments
var screen=figma.createFrame();
screen.name="05-segments - Segments";
screen.resize(1440,900);
screen.fills=[{type:'SOLID',color:BG}];
screen.x=6240;screen.y=14400;
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  txt(headerLeft,"Segmentlar",{size:13,color:G500});
  var headerActions=frame(header,"Actions",300,36,{layout:"HORIZONTAL",spacing:8});
  headerActions.primaryAxisSizingMode="AUTO";headerActions.counterAxisSizingMode="AUTO";
  headerActions.primaryAxisAlignItems="MAX";
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  txt(cardB0,"HTML sahifa: html/contacts/05-segments.html",{size:12,color:G400,w:600});
...
var screen=figma.createFrame();
screen.name="06-import-export - Import/Export";
screen.resize(1440,900);
screen.fills=[{type:'SOLID',color:BG}];
screen.x=7800;screen.y=14400;
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  var headerLeft=frame(header,"Header Left",400,40,{layout:"VERTICAL",spacing:2});
  headerLeft.primaryAxisSizingMode="AUTO";headerLeft.counterAxisSizingMode="AUTO";
  txt(headerLeft,"Import/Export",{style:"Semi Bold",size:20,color:G900});
  txt(headerLeft,"Ma'lumotlar almashinuvi",{size:13,color:G500});
  var headerActions=frame(header,"Actions",300,36,{layout:"HORIZONTAL",spacing:8});
  headerActions.primaryAxisSizingMode="AUTO";headerActions.counterAxisSizingMode="AUTO";
  headerActions.primaryAxisAlignItems="MAX";
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  // Card: Import/Export ma'lumotlari
  var card0=frame(content,"Card Import/Export ma'lumotlari",1132,200,{x:24,color:WHITE,radius:12,layout:"VERTICAL",stroke:G200,shadow:true});
  card0.primaryAxisSizingMode="AUTO";
  var cardH0=frame(card0,"Card Header",1132,48,{color:WHITE,layout:"HORIZONTAL",padX:20,padY:14,alignX:"CENTER"});
  cardH0.primaryAxisAlignItems="SPACE_BETWEEN";cardH0.layoutSizingHorizontal="FILL";
  txt(cardH0,"Import/Export ma'lumotlari",{style:"Semi Bold",size:15,color:G900});
  var cardB0=frame(card0,"Card Body",1132,150,{padX:20,padY:16});
  cardB0.layoutSizingHorizontal="FILL";cardB0.primaryAxisSizingMode="AUTO";cardB0.layoutMode="VERTICAL";cardB0.itemSpacing=8;
  
  txt(cardB0,"Bu sahifada Import/Export bo'limining asosiy kontenti joylashadi.",{size:14,color:G600,w:600,wrap:true});
  txt(cardB0,"HTML sahifa: html/contacts/06-import-export.html",{size:12,color:G400,w:600});
...
return {success:true, section:"CONTACTS", screens:6};
