...
screen.name="01-visitors-list - Online Visitors";
screen.resize(1440,900);
screen.fills=[{type:'SOLID',color:BG}];
screen.x=0;screen.y=15600;
  ...
  // Nav: Visitors
  var nav3=frame(sidebar,"Nav Visitors",240,36,{x:10,y:200,color:PRIMARY ,radius:8});
  
  txt(nav3,"Visitors",{style:"Medium",size:13,color:WHITE,x:36,y:9});
  // Nav: Automation
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  txt(headerLeft,"Online Visitors",{style:"Semi Bold",size:20,color:G900});
  txt(headerLeft,"Sayt ziyoratchilari",{size:13,color:G500});
  ...
  var sTab0=frame(subnav,"Tab Visitors List",128,36,{color:PRIMARY_LIGHT,radius:6,layout:"HORIZONTAL",alignY:"CENTER",alignX:"CENTER"});
  
  txt(sTab0,"Visitors List",{style:"Medium",size:13,color:PRIMARY});
  var sTab1=frame(subnav,"Tab Visitor Profile",144,36,{color:{r:0,g:0,b:0},radius:6,layout:"HORIZONTAL",alignY:"CENTER",alignX:"CENTER"});
  sTab1.fills=[];
  txt(sTab1,"Visitor Profile",{style:"Medium",size:13,color:G600});
  var sTab2=frame(subnav,"Tab Visitors Map",120,36,{color:{r:0,g:0,b:0},radius:6,layout:"HORIZONTAL",alignY:"CENTER",alignX:"CENTER"});
  sTab2.fills=[];
  txt(sTab2,"Visitors Map",{style:"Medium",size:13,color:G600});
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  // Card: Online Visitors ma'lumotlari
  var card0=frame(content,"Card Online Visitors ma'lumotlari",1132,200,{x:24,color:WHITE,radius:12,layout:"VERTICAL",stroke:G200,shadow:true});
  ...
  txt(cardH0,"Online Visitors ma'lumotlari",{style:"Semi Bold",size:15,color:G900});
  ...
  txt(cardB0,"Bu sahifada Online Visitors bo'limining asosiy kontenti joylashadi.",{size:14,color:G600,w:600,wrap:true});
  txt(cardB0,"HTML sahifa: html/visitors/01-visitors-list.html",{size:12,color:G400,w:600});
...
var screen=figma.createFrame();
screen.name="02-visitor-profile - Visitor Profile";
screen.resize(1440,900);
screen.fills=[{type:'SOLID',color:BG}];
screen.x=1560;screen.y=15600;
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  var headerLeft=frame(header,"Header Left",400,40,{layout:"VERTICAL",spacing:2});
  headerLeft.primaryAxisSizingMode="AUTO";headerLeft.counterAxisSizingMode="AUTO";
  txt(headerLeft,"Visitor Profile",{style:"Semi Bold",size:20,color:G900});
  txt(headerLeft,"Ziyoratchi profili",{size:13,color:G500});
  var headerActions=frame(header,"Actions",300,36,{layout:"HORIZONTAL",spacing:8});
  headerActions.primaryAxisSizingMode="AUTO";headerActions.counterAxisSizingMode="AUTO";
  headerActions.primaryAxisAlignItems="MAX";
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  // Card: Visitor Profile ma'lumotlari
  var card0=frame(content,"Card Visitor Profile ma'lumotlari",1132,200,{x:24,color:WHITE,radius:12,layout:"VERTICAL",stroke:G200,shadow:true});
  card0.primaryAxisSizingMode="AUTO";
  var cardH0=frame(card0,"Card Header",1132,48,{color:WHITE,layout:"HORIZONTAL",padX:20,padY:14,alignX:"CENTER"});
  cardH0.primaryAxisAlignItems="SPACE_BETWEEN";cardH0.layoutSizingHorizontal="FILL";
  txt(cardH0,"Visitor Profile ma'lumotlari",{style:"Semi Bold",size:15,color:G900});
  var cardB0=frame(card0,"Card Body",1132,150,{padX:20,padY:16});
  cardB0.layoutSizingHorizontal="FILL";cardB0.primaryAxisSizingMode="AUTO";cardB0.layoutMode="VERTICAL";cardB0.itemSpacing=8;
  
  txt(cardB0,"Bu sahifada Visitor Profile bo'limining asosiy kontenti joylashadi.",{size:14,color:G600,w:600,wrap:true});
  txt(cardB0,"HTML sahifa: html/visitors/02-visitor-profile.html",{size:12,color:G400,w:600});
...
var screen=figma.createFrame();
screen.name="03-visitors-map - Visitors Map";
screen.resize(1440,900);
screen.fills=[{type:'SOLID',color:BG}];
screen.x=3120;screen.y=15600;
...
var content=frame(screen,"Content",1180,900,{x:260,y:0,color:BG,layout:"VERTICAL",spacing:0});
  ...
  var headerLeft=frame(header,"Header Left",400,40,{layout:"VERTICAL",spacing:2});
  headerLeft.primaryAxisSizingMode="AUTO";headerLeft.counterAxisSizingMode="AUTO";
  txt(headerLeft,"Visitors Map",{style:"Semi Bold",size:20,color:G900});
  txt(headerLeft,"Xarita ko'rinishi",{size:13,color:G500});
  var headerActions=frame(header,"Actions",300,36,{layout:"HORIZONTAL",spacing:8});
  headerActions.primaryAxisSizingMode="AUTO";headerActions.counterAxisSizingMode="AUTO";
  headerActions.primaryAxisAlignItems="MAX";
...
var contentSpacer=frame(content,"Spacer",1180,16);contentSpacer.fills=[];
  ...
  // Card: Visitors Map ma'lumotlari
  var card0=frame(content,"Card Visitors Map ma'lumotlari",1132,200,{x:24,color:WHITE,radius:12,layout:"VERTICAL",stroke:G200,shadow:true});
  card0.primaryAxisSizingMode="AUTO";
  var cardH0=frame(card0,"Card Header",1132,48,{color:WHITE,layout:"HORIZONTAL",padX:20,padY:14,alignX:"CENTER"});
  cardH0.primaryAxisAlignItems="SPACE_BETWEEN";cardH0.layoutSizingHorizontal="FILL";
  txt(cardH0,"Visitors Map ma'lumotlari",{style:"Semi Bold",size:15,color:G900});
  var cardB0=frame(card0,"Card Body",1132,150,{padX:20,padY:16});
  cardB0.layoutSizingHorizontal="FILL";cardB0.primaryAxisSizingMode="AUTO";cardB0.layoutMode="VERTICAL";cardB0.itemSpacing=8;
  
  txt(cardB0,"Bu sahifada Visitors Map bo'limining asosiy kontenti joylashadi.",{size:14,color:G600,w:600,wrap:true});
  txt(cardB0,"HTML sahifa: html/visitors/03-visitors-map.html",{size:12,color:G400,w:600});
...
return {success:true, section:"VISITORS", screens:3};
